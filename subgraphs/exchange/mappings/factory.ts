...
import { OxdexFactory, Pair, Token, Bundle } from "../generated/schema";
...
export function handlePairCreated(event: PairCreated): void {
  let factory = OxdexFactory.load(FACTORY_ADDRESS);
  if (factory === null) {
    factory = new OxdexFactory(FACTORY_ADDRESS);
    factory.totalPairs = ZERO_BI;
    factory.totalTransactions = ZERO_BI;
    factory.totalVolumeOVA = ZERO_BD;
    factory.totalLiquidityOVA = ZERO_BD;
    factory.totalVolumeUSD = ZERO_BD;
    factory.untrackedVolumeUSD = ZERO_BD;
    factory.totalLiquidityUSD = ZERO_BD;

    let bundle = new Bundle("1");
    bundle.ovaPrice = ZERO_BD;
    bundle.save();
  }
  ...
  pair.trackedReserveOVA = ZERO_BD;
  pair.reserveOVA = ZERO_BD;
